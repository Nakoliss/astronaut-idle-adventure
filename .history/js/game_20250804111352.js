...
function updateDisplay() {
    document.getElementById("scrap-count").textContent = Math.floor(
        gameState.scrap
    );
    document.getElementById("ice-count").textContent = Math.floor(
        gameState.ice
    );
    document.getElementById("protein-count").textContent = Math.floor(
        gameState.protein
    );
    document.getElementById("fuel-count").textContent = Math.floor(
        gameState.fuel
    );
...
function updateButtonStates() {
    ...
    buildingButtons.forEach((button) => {
        const building = button.textContent.toLowerCase().includes("drone")
            ? "drone"
